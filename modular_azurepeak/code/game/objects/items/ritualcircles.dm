...
/obj/structure/ritualcircle/noc
	...
	desc = "A Holy Rune of Noc. Moonlight shines upon thee." // mortosasye cooked
...
/obj/structure/ritualcircle/xylix
	...
	icon_state = "xylix_chalky" // mortosasye cooked
...
/obj/structure/ritualcircle/ravox
	...
	icon_state = "ravox_chalky" // mortosasye cooked
	desc = "A Holy Rune of Ravox. A blade to protect the weak."
...
/obj/structure/ritualcircle/abyssor
	...
	icon_state = "abyssor_chalky" // mortosasye cooked
...
/obj/structure/ritualcircle/abyssor_alt // For future use with more malicious rituals, for example.
	...
	icon_state = "abyssoralt_active" // mortosasye cooked. change to abyssoralt_chalky if adding a new ritual, and use the active state instead for it.
...
/obj/structure/ritualcircle/baotha
	...
	icon_state = "baotha_chalky" // mortosasye sprite
		...
		if("Conversion")
			...
			if(do_after(user, 50))
				...
				if(do_after(user, 50))
					...
					if(do_after(user, 50))
						user.say("#The world's momentary pleasures have left us wanting...") // thank you pyrzal and zeratino
						if(do_after(user, 50))
